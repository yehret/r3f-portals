...
Command: npx gltfjsx@6.2.9 public/models/Orc_skull.gltf 
*/
        ...
        <group name="CharacterArmature">
          ...
          <group name="Orc_Skull">
            ...
            <skinnedMesh
              ...
              skeleton={nodes.Cube038_1.skeleton}
            />
            <skinnedMesh
              name="Cube038_2"
              geometry={nodes.Cube038_2.geometry}
              material={materials.Orc_Mouth}
              skeleton={nodes.Cube038_2.skeleton}
            />
            <skinnedMesh
              name="Cube038_3"
              geometry={nodes.Cube038_3.geometry}
              material={materials.Orc_Secondary}
              skeleton={nodes.Cube038_3.skeleton}
            />
            <skinnedMesh
              name="Cube038_4"
              geometry={nodes.Cube038_4.geometry}
              material={materials.Metal}
              skeleton={nodes.Cube038_4.skeleton}
            />
            <skinnedMesh
              name="Cube038_5"
              geometry={nodes.Cube038_5.geometry}
              material={materials.MushroomKing_Main}
              skeleton={nodes.Cube038_5.skeleton}
            />
          </group>
